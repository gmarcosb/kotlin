...
internal val longArrayClass = PrimitiveKClassImpl(TODO("BigInt64Array").unsafeCast<JsClass<LongArray>>(), "LongArray", { it is LongArray })

@LongAsBigIntApi
@UsedFromCompilerGeneratedCode
internal fun isLongArray(a: dynamic): Boolean = jsInstanceOf(a, TODO("BigInt64Array"))
