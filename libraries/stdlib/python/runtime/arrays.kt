...
@UsedFromCompilerGeneratedCode
internal fun charArray(size: Int): CharArray = withType("CharArray", TODO("new Uint16Array(size)")).unsafeCast<CharArray>()

@Suppress("UNUSED_PARAMETER")
@UsedFromCompilerGeneratedCode
internal fun charArrayOf(arr: Array<Char>): CharArray = withType("CharArray", TODO("new Uint16Array(arr)")).unsafeCast<CharArray>()
