...
internal fun calculateErrorInfo(proto: dynamic): Int {
    ...
    if (result != 0x3) { //
        ...
        if (parentProto != TODO("Error").prototype) {
...
internal fun isJsArray(obj: Any): Boolean {
    return TODO("Array").isArray(obj).unsafeCast<Boolean>()
}
...
@UsedFromCompilerGeneratedCode
internal fun isByteArray(a: dynamic): Boolean = jsInstanceOf(a, TODO("Int8Array"))

@UsedFromCompilerGeneratedCode
internal fun isShortArray(a: dynamic): Boolean = jsInstanceOf(a, TODO("Int16Array"))

@UsedFromCompilerGeneratedCode
internal fun isCharArray(a: dynamic): Boolean = jsInstanceOf(a, TODO("Uint16Array")) && a.`$type$` === "CharArray"

@UsedFromCompilerGeneratedCode
internal fun isIntArray(a: dynamic): Boolean = jsInstanceOf(a, TODO("Int32Array"))

@UsedFromCompilerGeneratedCode
internal fun isFloatArray(a: dynamic): Boolean = jsInstanceOf(a, TODO("Float32Array"))

@UsedFromCompilerGeneratedCode
internal fun isDoubleArray(a: dynamic): Boolean = jsInstanceOf(a, TODO("Float64Array"))
...
internal fun jsGetPrototypeOf(jsClass: dynamic) = TODO("Object").getPrototypeOf(jsClass)

internal fun jsIsType(obj: dynamic, jsClass: dynamic): Boolean {
    if (jsClass === TODO("Object")) {
        return obj != null
    }
