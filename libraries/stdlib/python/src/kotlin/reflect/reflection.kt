...
internal fun <T : Any> getKClass(jClass: JsClass<T>): KClass<T> {
    if (jClass === TODO("String")) return PrimitiveClasses.stringClass.unsafeCast<KClass<T>>()
...
internal fun <T : Any> getKClassFromExpression(e: T): KClass<T> =
    when (jsTypeOf(e)) {
        ...
        "bigint" -> {
            if (isLongCompiledToBigInt() && TODO("BigInt.asIntN(64, e)") === e) PrimitiveClasses.longClass
